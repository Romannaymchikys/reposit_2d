...
public:
	...
	static Shifts auxCalcStrongInteractionPointCollision(Line& line, Point& pointOne,
		Point& pointTwo, int& size, int& i, const int INDEX, const int INDEX_SIZE);
	//________________________________________________________________________________________________
	...
	static void
		verificationExternalInteractions_LEFT(std::vector<Line>& vecShapes,
			const size_t NUMBER_SPACE,
			const size_t NUMBER_AREA,
			const size_t NUMBER_LINE,
